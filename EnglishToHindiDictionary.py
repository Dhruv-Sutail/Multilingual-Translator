...
webpage = 'https://1000mostcommonwords.com/1000-most-common-hindi-words/'
...
for i in range(0, 2000):
    if i % 2 == 0:
        hindiWords.append(l[i])
    else:
        englishWords.append(l[i])

eng_to_hin = {}
for i in range(0, 1000):
    eng_to_hin[englishWords[i]] = hindiWords[i]
...
for i in range(0, 144):
    if i % 3 == 1:
        trsHin.append(totalList[i])
    elif i % 3 == 2:
        trsEng.append(totalList[i])

eng_to_hin2 = {}
for i in range(0, 48):
    eng_to_hin2[trsEng[i]] = trsHin[i]
